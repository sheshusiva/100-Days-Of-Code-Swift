...
class LoginViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    func setupRegisterButton() {
        ...
        registerButton.bottomAnchor.constraint(equalTo: passwordSeparatorView.bottomAnchor, constant: 100).isActive = true
    ...
    func setupCancelButton() {
        ...
        cancelButton.bottomAnchor.constraint(equalTo: registerButton.bottomAnchor, constant: 66).isActive = true
